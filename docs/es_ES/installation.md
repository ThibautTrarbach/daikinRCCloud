...
- Una **cuenta Daikin Onecta** (la misma que en la aplicación móvil)
...
2. Elija el modo **Mobile App (recomendado)**.
3. Introduzca el **email** y la **contraseña** de su cuenta Daikin Onecta (los mismos que en la aplicación móvil).
4. Haga clic en **Guardar**.

Para más detalles sobre los modos de conexión, consulte la página [Autenticación]({{ site.baseurl }}/es_ES/authentification.html).
