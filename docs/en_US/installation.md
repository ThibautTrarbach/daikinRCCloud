...
- Jeedom **4.4** or newer
- Cloud Daikin access: **Developer Portal** (Client ID / Client Secret) or **Mobile App** (Onecta email / password) — see [Authentication]({{ site.baseurl }}/en_US/authentification.html)
...
2. Choose the authentication mode: **Developer Portal (OAuth)** or **Mobile App**.
3. Enter the corresponding credentials (Client ID / Client Secret, or Onecta email / password).
4. Click **Save**.
5. Start the plugin service. For Developer Portal mode, follow the OAuth procedure in [Authentication]({{ site.baseurl }}/en_US/authentification.html).
